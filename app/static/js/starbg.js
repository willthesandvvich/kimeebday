...
function drawText() {
    ...
    if (frameNumber >= 3000 && frameNumber < 99999) {
        ...
        button.style.display = "none"; // Hide button during other frames
    }
...
function drawStaticText(text, x, y, fontSize = 30, color = "rgba(45, 45, 255, 1)") {
    context.font = fontSize + "px Comic Sans MS";
    context.textAlign = "center";
...
// Example usage:
// drawStaticText("Hello, World!", canvas.width / 2, canvas.height / 2);
